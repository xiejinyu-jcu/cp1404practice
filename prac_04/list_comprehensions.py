...
numbers_great_nine=[number for number in numbers if number>9]
print(numbers_great_nine)
...
longer_last_name=", ".join([name.split()[1] for name in full_names if len(name)>11])
print(longer_last_name)